...
module.exports = function (object, intent, roomObjects, roomTerrain, bulk, bulkUsers, roomController, stats, gameTime) {
    ...
    var effect = Math.floor(_.filter(object.body, function (i) {
        return i.hits > 0 && i.type == C.CLAIM;
    }).length * C.CONTROLLER_CLAIM_DOWNGRADE);
    if (!effect) {
        return;
    }
    ...
    if (target.reservation) {
        ...
        bulk.update(target, { reservation: { endTime: endTime } });
    }
    if (target.user) {
