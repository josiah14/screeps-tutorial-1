...
module.exports = function (object, intent, roomObjects, roomTerrain, bulk, bulkUsers, roomController, stats, gameTime) {
    ...
    if (object.user != target.user && _.any(roomObjects, function (i) {
        return i.type == C.STRUCTURE_RAMPART && i.user != object.user && !i.isPublic && i.x == target.x && i.y == target.y;
    })) {
        return;
    }
    ...
    if (target.type == 'lab') {
        ...
        bulk.update(target, _defineProperty({}, targetAmountKey, target[targetAmountKey]));
        ...
        bulk.update(target, _defineProperty({}, intent.resourceType, target[intent.resourceType]));
    }

    object[intent.resourceType] = object[intent.resourceType] || 0;
    object[intent.resourceType] += amount;

    bulk.update(object, _defineProperty({}, intent.resourceType, object[intent.resourceType]));
};
