...
function _applyDamage(object, damage) {
    ...
    if (_.any(object.body, function (i) {
        return !!i.boost;
    })) {
        for (var i = 0; i < object.body.length; i++) {
            ...
            var bodyPartHitsEffective = bodyPart.hits / damageRatio;
...
module.exports = function (object, roomObjects, roomTerrain, bulk, bulkUsers, roomController, stats, gameTime) {
    ...
    if (object.spawning) {
        ...
        if ((object.x == 0 || object.y == 0 || object.x == 49 || object.y == 49) && object.user != '2' && object.user != '3') {
            ...
            bulk.update(object, { interRoom: { room: room, x: x, y: y } });
        }

        var portal = _.find(roomObjects, function (i) {
            return i.type == 'portal' && i.x == object.x && i.y == object.y;
        });
        if (portal) {
    ...
    if (object.fatigue > 0) {
        ...
        if (object.fatigue < 0) object.fatigue = 0;
    ...
    if (object.userSummoned && _.any(roomObjects, function (i) {
        return i.type == 'creep' && i.user != '2' && i.user != roomController.user;
    })) {
        require('./_die')(object, roomObjects, bulk, stats);
    }

    var oldHits = object.hits;
