...
exports.make = function (_runtimeData, _intents, _register, _globals) {
    ...
    utils.defineGameObjectProperties(Nuke.prototype, data, {
        timeToLand: function timeToLand(o) {
            return o.landTime - runtimeData.time;
        },
        launchRoomName: function launchRoomName(o) {
            return o.launchRoomName;
        }
    });
...
//# sourceMappingURL=../sourcemaps/game/prototypes.js.map