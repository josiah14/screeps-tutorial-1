...
function _transfer(target, resourceType, amount) {
    ...
    if (this.my === false && _.any(this.pos.lookFor('structure'), function (i) {
        return i.structureType == C.STRUCTURE_RAMPART;
    })) {
        return C.ERR_NOT_OWNER;
    }
    ...
    intents.set(data(this.id)._id, 'transfer', { id: target.id, amount: amount, resourceType: resourceType });
    return C.OK;
}
...
function _transferEnergy(target, amount) {
    ...
    intents.set(this.id, 'transfer', { id: target.id, amount: amount, resourceType: 'energy' });
    return C.OK;
}
...
exports.make = function (_runtimeData, _intents, _register, _globals) {
    ...
    utils.defineGameObjectProperties(Structure.prototype, data, {
        hits: function hits(o) {
            return o.hits;
        },
        hitsMax: function hitsMax(o) {
            return o.hitsMax;
        },
    ...
    Structure.prototype.notifyWhenAttacked = register.wrapFn(function (enabled) {
        ...
        if (enabled != data(this.id).notifyWhenAttacked) {
            ...
            intents.set(this.id, 'notifyWhenAttacked', { enabled: enabled });
        }
    ...
    utils.defineGameObjectProperties(StructureContainer.prototype, data, {
        store: _storeGetter,
        storeCapacity: function storeCapacity(o) {
            return o.energyCapacity;
        },
        ticksToDecay: function ticksToDecay(o) {
            return o.nextDecayTime ? o.nextDecayTime - runtimeData.time : o.decayTime ? o.decayTime - runtimeData.time : undefined;
        }
    });
    ...
    utils.defineGameObjectProperties(StructureController.prototype, data, {
        ticksToDowngrade: function ticksToDowngrade(o) {
            return o.downgradeTime ? o.downgradeTime - runtimeData.time : undefined;
        },
        reservation: function reservation(o) {
            return o.reservation ? {
                username: runtimeData.users[o.reservation.user].username,
                ticksToEnd: o.reservation.endTime - runtimeData.time
            } : undefined;
        },
        level: function level(o) {
            return o.level;
        },
        progress: function progress(o) {
            return o.level > 0 ? o.progress : undefined;
        },
        progressTotal: function progressTotal(o) {
            return o.level > 0 && o.level < 8 ? C.CONTROLLER_LEVELS[o.level] : undefined;
        },
        upgradeBlocked: function upgradeBlocked(o) {
            return o.upgradeBlocked && o.upgradeBlocked > runtimeData.time ? o.upgradeBlocked - runtimeData.time : undefined;
        },
        safeMode: function safeMode(o) {
            return o.safeMode && o.safeMode > runtimeData.time ? o.safeMode - runtimeData.time : undefined;
        },
        safeModeCooldown: function safeModeCooldown(o) {
            return o.safeModeCooldown && o.safeModeCooldown > runtimeData.time ? o.safeModeCooldown - runtimeData.time : undefined;
        },
        safeModeAvailable: function safeModeAvailable(o) {
            return o.safeModeAvailable || 0;
        },
    ...
    StructureController.prototype.activateSafeMode = register.wrapFn(function () {
        ...
        if (_.any(register.structures, function (i) {
            return i.structureType == 'controller' && i.my && i.safeMode;
        })) {
            return C.ERR_BUSY;
        }
    ...
    utils.defineGameObjectProperties(StructureExtension.prototype, data, {
        energy: function energy(o) {
            return o.energy;
        },
        energyCapacity: function energyCapacity(o) {
            return o.energyCapacity;
        }
    });
    ...
    utils.defineGameObjectProperties(StructureKeeperLair.prototype, data, {
        ...
        owner: function owner() {
            return { username: 'Source Keeper' };
        },
        ticksToSpawn: function ticksToSpawn(o) {
            return o.nextSpawnTime ? o.nextSpawnTime - runtimeData.time : undefined;
        }
    });
    ...
    utils.defineGameObjectProperties(StructureLab.prototype, data, {
        ...
        mineralCapacity: function mineralCapacity(o) {
            return o.mineralCapacity;
        },
    ...
    StructureLab.prototype.runReaction = register.wrapFn(function (lab1, lab2) {
        ...
        if (!lab2 || !lab1.id || !register.structures[lab2.id] || !(lab2 instanceof globals.Structure) || lab2.structureType != C.STRUCTURE_LAB || lab2.id == this.id) {
    ...
    StructureLab.prototype.boostCreep = register.wrapFn(function (target, bodyPartsCount) {
        ...
        var nonBoostedParts = _(target.body).filter(function (i) {
            return !i.boost && C.BOOSTS[i.type][data(_this.id).mineralType];
        }).size();
        ...
        intents.set(this.id, 'boostCreep', { id: target.id, bodyPartsCount: bodyPartsCount });
        return C.OK;
    });
    ...
    StructureLink.prototype.transferEnergy = register.wrapFn(function (target, amount) {
        ...
        if (!target || !target.id || !register.structures[target.id] && !register.creeps[target.id] || !(target instanceof globals.Structure) && !(target instanceof globals.Creep) || target === this) {
            register.assertTargetObject(target);
            return C.ERR_INVALID_TARGET;
        }
        if (!target.my) {
        ...
        if (target instanceof globals.Creep) {
            ...
            register.deprecated('`StructureLink.transferEnergy` applied to creeps is considered deprecated and will be ' + 'removed soon. Please use `Creep.withdraw` instead.');
    ...
    StructureObserver.prototype.observeRoom = register.wrapFn(function (roomName) {
        ...
        intents.set(this.id, 'observeRoom', { roomName: roomName });
        return C.OK;
    });
    ...
    utils.defineGameObjectProperties(StructurePowerSpawn.prototype, data, {
        ...
        powerCapacity: function powerCapacity(o) {
            return o.powerCapacity;
        }
    });
    ...
    utils.defineGameObjectProperties(StructureTerminal.prototype, data, {
        ...
        cooldown: function cooldown(o) {
            return o.cooldownTime && o.cooldownTime > runtimeData.time ? o.cooldownTime - runtimeData.time : 0;
        }
    });
    ...
    StructureTerminal.prototype.send = register.wrapFn(function (resourceType, amount, targetRoomName, description) {
        ...
        if (resourceType != C.RESOURCE_ENERGY && data(this.id).energy < cost || resourceType == C.RESOURCE_ENERGY && data(this.id).energy < amount + cost) {
            return C.ERR_NOT_ENOUGH_RESOURCES;
        }
        ...
        intents.set(this.id, 'send', { resourceType: resourceType, amount: amount, targetRoomName: targetRoomName, description: description });
        return C.OK;
    });
    ...
    StructureTower.prototype.attack = register.wrapFn(function (target) {
        ...
        if (!target || !target.id || !register.creeps[target.id] && !register.structures[target.id] || !(target instanceof globals.Creep) && !(target instanceof globals.StructureSpawn) && !(target instanceof globals.Structure)) {
            register.assertTargetObject(target);
            return C.ERR_INVALID_TARGET;
        }
    ...
    utils.defineGameObjectProperties(StructureWall.prototype, data, {
        ticksToLive: function ticksToLive(o) {
            return o.ticksToLive;
        }
    });
    ...
    utils.defineGameObjectProperties(StructureSpawn.prototype, data, {
        name: function name(o) {
            return o.user == runtimeData.user._id ? o.name : undefined;
        },
        energy: function energy(o) {
            return o.energy;
        },
        ...
        spawning: function spawning(o) {
            return o.spawning || null;
        }
    });
    ...
    StructureSpawn.prototype.createCreep = register.wrapFn(function (body, name, creepMemory) {
        ...
        if (!name) {
            name = require('./names').getUniqueName(function (i) {
                return _.any(runtimeData.roomObjects, { type: 'creep', user: data(_this2.id).user, name: i }) || createdCreepNames.indexOf(i) != -1;
            });
        }
        ...
        Object.defineProperties(globals.Game.creeps[name], {
            ...
            body: {
                enumerable: true,
                get: function get() {
                    return _.map(body, function (type) {
                        return { type: type, hits: 100 };
                    });
                }
            },
            owner: {
            ...
            carryCapacity: {
                enumerable: true,
                get: function get() {
                    return _.reduce(body, function (result, type) {
                        return result += type == C.CARRY ? C.CARRY_CAPACITY : 0;
                    }, 0);
                }
            },
            carry: {
        ...
        intents.set(this.id, 'createCreep', { name: name, body: body });
        return name;
    });
    ...
    StructureSpawn.prototype.transferEnergy = register.wrapFn(function (target, amount) {
        ...
        intents.set(this.id, 'transferEnergy', { id: target.id, amount: amount });
        return C.OK;
    });
    ...
    utils.defineGameObjectProperties(StructureNuker.prototype, data, {
        ...
        ghodium: function ghodium(o) {
            return o.G;
        },
        ghodiumCapacity: function ghodiumCapacity(o) {
            return o.GCapacity;
        },
        cooldown: function cooldown(o) {
            return o.cooldownTime && o.cooldownTime > runtimeData.time ? o.cooldownTime - runtimeData.time : 0;
    ...
    utils.defineGameObjectProperties(StructurePortal.prototype, data, {
        destination: function destination(o) {
            return new globals.RoomPosition(o.destination.x, o.destination.y, o.destination.room);
        },
        ticksToDecay: function ticksToDecay(o) {
            return o.decayTime ? o.decayTime - runtimeData.time : undefined;
        }
    });
