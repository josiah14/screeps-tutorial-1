...
exports.make = function (_runtimeData, _intents, _register, _globals) {
    ...
    utils.defineGameObjectProperties(Creep.prototype, data, {
        ...
        ticksToLive: function ticksToLive(o) {
            return o.ageTime ? o.ageTime - runtimeData.time : undefined;
        },
        carryCapacity: function carryCapacity(o) {
            return o.energyCapacity;
        },
        carry: function carry(o) {
    ...
    Creep.prototype.move = register.wrapFn(function (direction) {
        ...
        intents.set(this.id, 'move', { direction: direction });
        return C.OK;
    });
    ...
    Creep.prototype.moveByPath = register.wrapFn(function (path) {
        ...
        if (_.isArray(path) && path.length > 0 && path[0] instanceof globals.RoomPosition) {
            var idx = _.findIndex(path, function (i) {
                return i.isEqualTo(_this.pos);
            });
            if (idx === -1) {
        ...
        var cur = _.find(path, function (i) {
    ...
    Creep.prototype.drop = register.wrapFn(function (resourceType, amount) {
        ...
        intents.set(this.id, 'drop', { amount: amount, resourceType: resourceType });
        return C.OK;
    });
    ...
    Creep.prototype.transfer = register.wrapFn(function (target, resourceType, amount) {
        ...
        if (!target || !target.id || !register.spawns[target.id] && !register.creeps[target.id] && !register.structures[target.id] || !(target instanceof globals.StructureSpawn) && !(target instanceof globals.Structure) && !(target instanceof globals.Creep)) {
            register.assertTargetObject(target);
            return C.ERR_INVALID_TARGET;
        }
        if (resourceType == C.RESOURCE_ENERGY) {
            ...
            if (register.structures[target.id] && register.structures[target.id].structureType != 'extension' && register.structures[target.id].structureType != 'spawn' && register.structures[target.id].structureType != 'link' && register.structures[target.id].structureType != 'storage' && register.structures[target.id].structureType != 'tower' && register.structures[target.id].structureType != 'powerSpawn' && register.structures[target.id].structureType != 'terminal' && register.structures[target.id].structureType != 'container' && register.structures[target.id].structureType != 'lab' && register.structures[target.id].structureType != 'nuker') {
                return C.ERR_INVALID_TARGET;
            }
        } else if (resourceType == C.RESOURCE_POWER) {
            if (register.structures[target.id] && register.structures[target.id].structureType != 'storage' && register.structures[target.id].structureType != 'terminal' && register.structures[target.id].structureType != 'container' && register.structures[target.id].structureType != 'powerSpawn') {
                return C.ERR_INVALID_TARGET;
            }
        } else {
            if (register.structures[target.id] && register.structures[target.id].structureType != 'storage' && register.structures[target.id].structureType != 'terminal' && register.structures[target.id].structureType != 'container' && register.structures[target.id].structureType != 'lab' && register.structures[target.id].structureType != 'nuker') {
                return C.ERR_INVALID_TARGET;
            }
        }
        ...
        intents.set(this.id, 'transfer', { id: target.id, amount: amount, resourceType: resourceType });
        return C.OK;
    });
    ...
    Creep.prototype.withdraw = register.wrapFn(function (target, resourceType, amount) {
        ...
        if (target.my === false && _.any(target.pos.lookFor('structure'), function (i) {
            return i.structureType == C.STRUCTURE_RAMPART && !i.my && !i.isPublic;
        })) {
            return C.ERR_NOT_OWNER;
        }
        ...
        if (resourceType == C.RESOURCE_ENERGY) {
            ...
            if (register.structures[target.id] && register.structures[target.id].structureType != 'storage' && register.structures[target.id].structureType != 'terminal' && register.structures[target.id].structureType != 'container' && register.structures[target.id].structureType != 'lab') {
                return C.ERR_INVALID_TARGET;
            }
        }
        ...
        intents.set(this.id, 'withdraw', { id: target.id, amount: amount, resourceType: resourceType });
        return C.OK;
    });
    ...
    Creep.prototype.build = register.wrapFn(function (target) {
        ...
        if (_.contains(C.OBSTACLE_OBJECT_TYPES, target.structureType) && _.any(register.objectsByRoom[data(this.id).room], function (i) {
        ...
        if (target.progress + buildEffect >= target.progressTotal && !utils.checkControllerAvailability(target.structureType, register.objectsByRoom[data(this.id).room], this.room.controller, 1)) {
            return C.ERR_RCL_NOT_ENOUGH;
        }
    ...
    Creep.prototype.say = register.wrapFn(function (message, isPublic) {
        ...
        intents.set(this.id, 'say', { message: "" + message, isPublic: isPublic });
        return C.OK;
    });
    ...
    Creep.prototype.dismantle = register.wrapFn(function (target) {
        ...
        if (!target || !target.id || !register.structures[target.id] || !(target instanceof globals.Structure) && !(target instanceof globals.StructureSpawn) || target instanceof globals.StructurePowerBank) {
            register.assertTargetObject(target);
            return C.ERR_INVALID_TARGET;
        }
        if (!target.pos.isNearTo(this.pos)) {
