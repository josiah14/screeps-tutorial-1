...
function processRoom(roomId, intents, objects, terrain, gameTime, roomInfo, flags) {
    ...
    return q.when().then(function () {
        ...
        if (intents) {
            ...
            _.forEach(intents.users, function (userIntents, userId) {
                ...
                for (var objectId in userIntents.objects) {
                    ...
                    if (object.type == 'creep') require('./processor/intents/creeps/intents')(object, objectIntents, objects, terrain, bulk, userBulk, roomController, stats, gameTime, roomInfo);
                    if (object.type == 'link') require('./processor/intents/links/intents')(object, objectIntents, objects, terrain, bulk, userBulk, roomController, stats);
                    if (object.type == 'tower') require('./processor/intents/towers/intents')(object, objectIntents, objects, terrain, bulk, userBulk, roomController, stats, gameTime, roomInfo);
                    if (object.type == 'lab') require('./processor/intents/labs/intents')(object, objectIntents, objects, terrain, bulk, userBulk, roomController, stats);
                    if (object.type == 'spawn') require('./processor/intents/spawns/intents')(object, objectIntents, objects, terrain, bulk, userBulk, roomController, stats, gameTime);
                    ...
                    driver.config.emit('processObjectIntents', object, userId, objectIntents, objects, terrain, gameTime, roomInfo, bulk, userBulk);
                }
            });
        }
        ...
        var energyAvailable = _(objects).filter(function (i) {
            return !i.off && (i.type == 'spawn' || i.type == 'extension');
        }).sum('energy');
        ...
        _.forEach(objects, function (object) {
            ...
            if (object.type == 'energy') require('./processor/intents/energy/tick')(object, objects, terrain, bulk, userBulk, roomController);
            if (object.type == 'source') require('./processor/intents/sources/tick')(object, objects, terrain, bulk, userBulk, roomController, gameTime);
            if (object.type == 'mineral') require('./processor/intents/minerals/tick')(object, objects, terrain, bulk, userBulk, roomController, gameTime);
            if (object.type == 'creep') require('./processor/intents/creeps/tick')(object, objects, terrain, bulk, userBulk, roomController, stats, gameTime);
            if (object.type == 'spawn') require('./processor/intents/spawns/tick')(object, objects, terrain, bulk, userBulk, roomController, stats, energyAvailable);
            if (object.type == 'rampart') require('./processor/intents/ramparts/tick')(object, objects, terrain, bulk, userBulk, roomController, gameTime);
            if (object.type == 'extension') require('./processor/intents/extensions/tick')(object, objects, terrain, bulk, userBulk, roomController, gameTime);
            if (object.type == 'road') require('./processor/intents/roads/tick')(object, objects, terrain, bulk, userBulk, roomController, gameTime);
            if (object.type == 'constructionSite') require('./processor/intents/construction-sites/tick')(object, objects, terrain, bulk, userBulk, roomController);
            if (object.type == 'keeperLair') require('./processor/intents/keeper-lairs/tick')(object, objects, terrain, bulk, userBulk, roomController, gameTime);
            if (object.type == 'portal') require('./processor/intents/portals/tick')(object, objects, terrain, bulk, userBulk, roomController, gameTime);
            if (object.type == 'constructedWall') require('./processor/intents/constructedWalls/tick')(object, objects, terrain, bulk, userBulk, roomController, gameTime);
            if (object.type == 'link') require('./processor/intents/links/tick')(object, objects, terrain, bulk, userBulk, roomController);
            if (object.type == 'extractor') require('./processor/intents/extractors/tick')(object, objects, terrain, bulk, userBulk, roomController);
            if (object.type == 'tower') require('./processor/intents/towers/tick')(object, objects, terrain, bulk, userBulk, roomController);
            if (object.type == 'controller') require('./processor/intents/controllers/tick')(object, objects, terrain, bulk, userBulk, roomController, gameTime, roomInfo);
            if (object.type == 'lab') require('./processor/intents/labs/tick')(object, objects, terrain, bulk, userBulk, roomController, gameTime);
            if (object.type == 'container') require('./processor/intents/containers/tick')(object, objects, terrain, bulk, userBulk, roomController, gameTime);
            if (object.type == 'terminal') require('./processor/intents/terminal/tick')(object, objects, terrain, bulk, userBulk, roomController, gameTime);
            ...
            if (object.type == 'storage') {
                if (roomController) {
                    ...
                    if (energyCapacity != object.energyCapacity) {
                        bulk.update(object, { energyCapacity: energyCapacity });
                    }
                }
            }
            ...
            if (object.user) {
                ...
                if (object.type != 'constructionSite' && !object.newbieWall && (object.type != 'rampart' || !object.isPublic)) {
...
function saveRoomHistory(roomId, objects, gameTime) {
    ...
    return currentHistoryPromise.then(function () {
        var promise = q.when();
        ...
        currentHistoryPromise = promise.then(function () {
            return driver.history.saveTick(roomId, gameTime, data);
        });
        return currentHistoryPromise;
    });
}

driver.connect('processor').then(function () {
    return driver.queue.create('rooms', 'read');
}).then(function (_roomsQueue) {
    ...
    function loop() {
        ...
        roomsQueue.fetch().then(function (_roomId) {
            ...
            processRoom(roomId, result[0], result[1], result[2], result[3], result[4], result[5]).catch(function (error) {
                return console.log('Error processing room ' + roomId + ':', _.isObject(error) ? error.stack || error : error);
            }).then(function () {
                return driver.clearRoomIntents(roomId);
            }).then(function () {
                return roomsQueue.markDone(roomId);
            });
        }).catch(function (error) {
            return console.error('Error in processor loop:', _.isObject(error) && error.stack || error);
        }).then(function () {
